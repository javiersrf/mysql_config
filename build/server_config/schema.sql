...
ALTER TABLE smartfleet.operador MODIFY id int AUTO_INCREMENT PRIMARY KEY,MODIFY code varchar(20)  UNIQUE NOT NULL;
INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('Peter Mechanic', '310dcbbf4cce62f762a2aaa148d556bd', '333', 3, 100, 'dark');"
INSERT INTO smartfleet.operador ( name, senha, code, type_id, status_id, theme) VALUES ('MATEUS FELIPE ROGGE', '45fbc6d3e05ebd93369ce542e8f2322d', '216', 8, 100, 'dark');"
INSERT INTO smartfleet.operador ( name, senha, code, type_id, status_id, theme) VALUES ('PAULO VAIS', '091d584fced301b442654dd8c23b3fc9', '208', 3, 100, 'dark');"
INSERT INTO smartfleet.operador ( name, senha, code, type_id, status_id, theme) VALUES ('DAMARCI SOARES', '1534b76d325a8f591b52d302e7181331', '212', 8, 100, 'dark');"
INSERT INTO smartfleet.operador ( name, senha, code, type_id, status_id, theme) VALUES ('Mecanico/Operador', 'e4da3b7fbbce2345d7772b0674a318d5', '5', 3, 100, 'dark');"
INSERT INTO smartfleet.operador ( name, senha, code, type_id, status_id, theme) VALUES ('Mecanico Terceiro', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', '3', 3, 100, 'dark');"

operador
	


INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('EDINEI ROMANOSKI','4c56ff4ce4aaf9573aa5dff913df997a', '121', 4, 100, 'dark');
INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('SILVESTRE DA LUZ', 'da4fb5c6e93e74d3df8527599fa62642', '120', 4, 100, 'dark');
INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('WILLIAM SANTANA	', md5('125'), '125', 4, 100, 'dark');
INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('OSNI ESQUINCA	', '3def184ad8f4755ff269862ea77393dd', '115', 4, 100, 'dark');
INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('JORGE LODI	', '1afa34a7f984eeabdbb0a7d494132ee5', '131', 4, 100, 'dark');
INSERT INTO smartfleet.operador (name, senha, code, type_id, status_id, theme) VALUES ('MARCIO CALDAS', 'a97da629b098b75c294dffdc3e463904', '107', 4, 100, 'dark');
